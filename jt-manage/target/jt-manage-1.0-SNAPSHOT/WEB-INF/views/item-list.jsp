    ...
    var toolbar = [{
        	...
        	$("#itemEditWindow").window({
        		onLoad :function(){
        			...
        			*/
                    ...
                    $.get("/item/cat/queryItemName",{"itemCatId":cid},function(result){
                        $("#itemeEditForm input[name='cid']").prev("span").text(result);
                    })
        ...
        handler:function(){
        	...
        	$.messager.confirm('确认','确定下架ID为 '+ids+' 的商品吗？',function(r){
        	    if (r){
        	    	var params = {"ids":ids};
                	$.post("/item/updateState/2",params, function(data){
            			if(data.status == 200){
        ...
        handler:function(){
        	...
        	$.messager.confirm('确认','确定上架ID为 '+ids+' 的商品吗？',function(r){
        	    if (r){
        	    	var params = {"ids":ids};
                	$.post("/item/updateState/1",params, function(data){
            			if(data.status == 200){
